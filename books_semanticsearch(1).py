...
df_books = pd.read_csv('/Users/namitbansal/Desktop/python/final_books_dataset.csv')
...
def search_similar_books(search_term):
    ...
    return pd.DataFrame(book_names, columns=['Relevance', 'Book Title', 'Book Link', 'Rating Count'])


#print(search_similar_books('Data Science'))
