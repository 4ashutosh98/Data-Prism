...
dfpy.wdcloud(youtdf1)
yt_df=dfpy.search_similar_videos('data science tutorials',youtdf)
print(yt_df)
    ...
    if event == 'Next':
        ...
        if layoutvar == 2:
            ...
            if entity == 'Books':
                ...
                figure_agg=draw_figure(window[f'-CANVAS1-'].TKCanvas, book_rating_plot(book_df.copy()))
